        ...
        <div className='About'>
            <div className='relative'>
                ...
                <div className='wrapper'>
                    <h1 style={{fontSize:'50px' , color:'white'}}>About</h1>
                    <p style={{fontSize:'16px' , color:'#a3a3a3'}}><Link style={{textDecoration:'none', color:'#a3a3a3'}} to='/'>Home / </Link><span style={{color:'white'}}>About</span></p>
                </div>
            </div>
